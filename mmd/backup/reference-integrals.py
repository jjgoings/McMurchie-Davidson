#
#   OLD CODE WITHOUT CYTHON FOR REFERENCE
#
...
#    # Generalized nuclear repulsion integrals for derivatives of GIAOs
#    # nucleus is centered at 'C'
#    # normal nuclear repulsion  corresponse to n = (0,0,0) case
#    v = 0.0
#    for ia, ca in enumerate(a.coefs):
#        for ib, cb in enumerate(b.coefs):
